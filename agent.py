...
class DoubleDQN(DQN):
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size=100000, eps_steps=100000,
        ...
        DQN.__init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size, eps_steps,
                 fc1_dims=fc1_dims, fc2_dims=fc2_dims, update_target=update_target, eps_min=eps_min)
...
class DDDQN(DoubleDQN):
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size=100000, eps_steps=100000,
        ...
        DoubleDQN.__init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size, eps_steps, fc1_dims,
                     fc2_dims, update_target, eps_min=eps_min)
...
class NStep3DQN(DDDQN):
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,n=3, fc1_dims=256, fc2_dims=256, max_mem_size=100000, eps_steps=100000, update_target=100, eps_min=0.01):
        DDDQN.__init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size, eps_steps, fc1_dims, fc2_dims, update_target, eps_min=eps_min)
        self.name = "NStep3DQN"
        self.n = n
...
class NoisyNStep3DQN(NStep3DQN):
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,n=3, fc1_dims=256, fc2_dims=256, max_mem_size=100000, eps_steps=100000, update_target=100, eps_min=0.01):
        NStep3DQN.__init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, n=n, fc1_dims=fc1_dims, fc2_dims=fc2_dims, max_mem_size=max_mem_size, eps_steps=eps_steps, update_target=update_target, eps_min=eps_min)
